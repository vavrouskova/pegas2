...
interface ShowroomBranchesSectionProps {
...
const ShowroomBranchesSection = ({ branches, title }: Readonly<ShowroomBranchesSectionProps>) => {
  // Filter branches that have showRoom set to true
  const showroomBranches = branches.filter((branch) => branch.pobockyACF?.showRoom === true);

  if (showroomBranches.length === 0) return null;
...
export default ShowroomBranchesSection;
